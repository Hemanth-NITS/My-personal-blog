...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      />
      and I want to discuss something with you. You can email me at
      ...
      <input
        ...
        focus:border-gray bg-transparent"
      />.
      Here are some details about me: <br />
      <textarea {...register("my details", {})} 
      placeholder="Your personal details..."
      rows={3}
