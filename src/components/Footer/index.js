...
import { DribbbleIcon, FacebookIcon, GithubIcon, InstagramIcon, LinkedinIcon, TwitterIcon, XIcon } from "../Icons";
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      <h3 className="mt-16 font-medium dark:font-bold text-center capitalize text-2xl sm:text-3xl lg:text-4xl px-4">
        Stories | Career Updates | My Learnings
      </h3>
      <p className="mt-5 px-4 text-center w-full sm:w-3/5 font-light dark:font-medium text-sm sm:text-base">
      Follow my tech journey—I'm a student diving into new technologies and sharing my discoveries.
      </p>
      ...
      <div className="w-full  mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-center">
          Made with &hearts; by{" "}
          <a href="https://github.com/Hemanth-NITS" className="underline" target="_blank">
            K N V HEMANTH SAI KUMAR
          </a>
        </div>
      </div>
    </footer>
